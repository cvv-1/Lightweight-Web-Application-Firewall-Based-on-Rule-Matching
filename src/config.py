...
# 控制端信号：重新加载站点配置
CONTROL_RELOAD_SITES = "<-RELOAD_SITES->"
...
if LOCAL_DEBUG:
	...
	REAL_HOST = '127.0.0.1'
	REAL_PORT = 8082  # 与WAF监听日志中的地址匹配

	# 代理服务器的工作地址和端口
	# 即用户访问的地址和端口
	PROXY_HOST = '127.0.0.1'
	PROXY_PORT = 8081  # 与WAF监听日志中的端口匹配
else:
	# 被代理的真实地址和端口
...
DB_NAME_SITES = "waf_site"
## Django 数据库表中字段名
DB_TABLE_RULES = "(action,content,description)"
DB_TABLE_LOGS = "(time,ip,url,action,rule_id,reason)"
